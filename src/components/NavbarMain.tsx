            ...
            <Nav>
              ...
              <UnList>
                <MobileMenu isOpen={isMenuOpen}>
                  ...
                  <div style={{display: "flex", flexDirection: "column", justifyContent:"space-between", alignItems:"flex-start"}} className="nav-btns">
          <Link to="/login">
            <Button style={{margin:"0.2rem 0 1rem 0"}}>Login</Button>
          </Link>
          <Link to="/signup">
            <Button style={{margin:"auto"}}>Sign up</Button>
              ...
              <DesktopMenu><div style={{display: "flex"}} className="nav-btns">
          <Link to="/login">
            <Button>Login</Button>
          </Link>
          <Link to="/signup">
